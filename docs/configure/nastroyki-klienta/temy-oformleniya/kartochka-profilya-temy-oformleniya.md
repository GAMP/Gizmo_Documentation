...
В данном подразделе настраивается внешний вид и поведение экрана входа в Gizmo Client.
...
В данном подразделе настраивается отображение номера хоста в интерфейсе Gizmo Client.
...
В данном подразделе загружаются медиафайлы, используемые в интерфейсе Gizmo Client.
...
Для загрузки файла перетащите его в соответствующую область или нажмите **«Загрузить файл»**.

## Ротатор входа в систему

При включении данной опции на экране входа отображаются медиафайлы из указанной папки, сменяющие друг друга с заданным интервалом.
...
При включении данной опции в Gizmo Client отображается главная страница.
...
При включении данной опции в Gizmo Client отображается страница магазина.
...
При включении данной опции в Gizmo Client отображается раздел каналов.
...
**Пользовательский CSS** - поле для ввода пользовательских CSS-стилей, позволяющих кастомизировать внешний вид интерфейса Gizmo Client. Стили можно ввести вручную или загрузить из файла, нажав кнопку **«Загрузить файл CSS»**.

Для удаления профиля темы оформления нажмите кнопку **«Удалить»** в правом нижнем углу страницы.
