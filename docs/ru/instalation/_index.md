...
Настройка Companion на этом закончена, но касса и терминал ещё не подключены технически -- это отдельный процесс, и мы помогаем с ним удалённо. Обратитесь в поддержку, чтобы завершить физическое подключение оборудования.
...
-  Перейдите в <cmd text="Настройки"/> -> <cmd text="Кассы"/> и выберите пк, с которого будете продавать. Если касс несколько, ориентируйтесь по названию и номеру пк, которые вы указывали при создании компаньона.
