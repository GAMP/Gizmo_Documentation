...
Подробнее про группы пользователей -- в статье [«Группы пользователей»](./../tutorials/staff/user-groups.md).
...
Подробнее о бонусной системе и баллах -- в статье [«Бонусные баллы для клиентов»](./../tutorials/loyalty/loyalty-program.md).
...
Настройка Companion на этом закончена, но касса и терминал ещё не подключены технически -- это отдельный процесс, и мы помогаем с ним удалённо. Чек-лист подготовки к обращению в поддержку -- в статье [«Подключение кассы и терминала»](./../tutorials/sales/register/pos-terminal-setup.md).
...
-  Перейдите в <cmd text="Настройки"/> -> <cmd text="Кассы"/> и выберите пк, с которого будете продавать. Если касс несколько и вы не уверены, какая из них какому пк соответствует -- смотрите статью [«Подключение кассы и терминала»](./../tutorials/sales/register/pos-terminal-setup.md).
