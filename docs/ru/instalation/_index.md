...
Подробный разбор мастера настройки со всеми параметрами и скриншотами -- в статье [«Мастер настройки Gizmo Server»](./gizmo/self-hosted/gizmo-server/setup-wizard.md).
