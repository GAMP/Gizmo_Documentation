...
order: 0.9
aliases:
  - path: ru/instalation/gizmo/self-hosted/gizmo-server/setup-wizard
    moved: "2026-08-31T13:13:24Z"
---
...
> [!NOTE]
> 
> Данные личного кабинета нужны здесь для того, чтобы сервер мог активировать лицензию и получать обновления. Если вы ещё не зарегистрировали личный кабинет -- сделайте это в статье «Личный кабинет» прежде, чем продолжать.
...
![](./setup-wizard-5.png){width=252px height=150px}
...
![](./setup-wizard-3.png){width=341px height=148px}
...
![](./setup-wizard-6.png){width=404px height=149px}
