...
-  Укажите логин и пароль, которые использовали при регистрации личного кабинета на сайте Gizmo, и нажмите <cmd text="Далее"/>. Эти данные нужны здесь для того, чтобы сервер мог активировать лицензию и получать обновления. Если вы ещё не зарегистрировали личный кабинет -- сделайте это на сайте Gizmo прежде, чем продолжать.
