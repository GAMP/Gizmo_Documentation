...
Пошаговая инструкция по настройке -- в статье «Фискализация чеков в РФ».
...
Здесь можно создать налоговые ставки на товары (НДС), которые учитываются при продаже, если в карточке продукта указана ассоциация с одной из этих ставок.

Чтобы добавить ставку, нажмите <cmd text="Создать налог"/> в правом углу подраздела и заполните столбцы «Имя» и «Значение» в появившейся строке. Значения указываются в процентах, формат -- `5.20`.
