...
-  **Период покупки/продажи** -- при включении использование пакета ограничено определёнными временными периодами. Периоды добавляются кнопкой <cmd text="+"/>.
...
-  **Период покупки/продажи** -- при включении продажа пакета ограничена определёнными временными периодами. Периоды добавляются кнопкой <cmd text="+"/>.
