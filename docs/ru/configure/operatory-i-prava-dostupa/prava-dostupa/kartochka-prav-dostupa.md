...
Права доступа сгруппированы по категориям. Для каждой категории отображается количество включённых разрешений (например, 19/22). Категорию можно свернуть или развернуть, нажав на стрелку справа от её названия. Кнопка **«Свернуть все»** сворачивает все категории одновременно.

Для быстрого поиска нужного разрешения используйте поле **«Поиск»**.
...
-  Еще не оплаченные - работа со счетами, ожидающими оплаты.
...
-  Развертывание - возможность проводить развертывание при продаже.
