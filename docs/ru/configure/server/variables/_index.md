...
Чтобы добавить новую переменную, нажмите <cmd text="Добавить переменную"/> в правом верхнем углу -- поля для заполнения описаны в статье [«Добавление новой переменной»](./add-new-var.md).