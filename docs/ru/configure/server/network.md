...
-  **Восстановление имени хоста** -- при включении галочки, Gizmo изменяет имя устройства в системе Windows на имя компьютера, заданное в настройках хоста в Gizmo Manager.