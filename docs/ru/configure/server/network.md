...
Блок в нижней части страницы. Представляет собой таблицу из двух столбцов -- **Функция** и
**Включить** -- со списком функций, которые включаются переключателем.

-  **Только зарегистрированные** -- см. вопрос к разделу ниже.

-  **Восстановление имени хоста** -- при включении Gizmo назначает клиентскому ПК то имя,
   которое указано в поле **Имя хоста** [карточки компьютера](./../../usage/gizmo-manager/stations/computers/computer-card.md),
   и делает это при каждом подключении.