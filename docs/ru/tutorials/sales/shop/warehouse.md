...
-  Откройте <cmd text="Настройки"/> -> <cmd text="Кассы"/> и выберите кассу, которая относится к вашей точке продаж. Подробнее о кассах -- в статье «Подключение кассы и терминала».
