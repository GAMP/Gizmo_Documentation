...
<color color="#fc7b03">**Это сложное руководство, и оно может вызывать трудности на некоторых этапах. При любых вопросах рекомендуем **[**обратиться в поддержку**](./../about/support.md)**, или доверить все нам, создав заявку на обновление клуба -- это бесплатно.**</color>
...
-  [Загрузите ](https://gizmopowered.net/downloads/v3/latest/GizmoServiceSetup.exe)и установите установщик нового сервера. Старую версию удалять не нужно, достаточно пройти все шаги в установщике.
...
> [!NOTE]
> 
> Если интеграция с ККМ-сервером ранее настраивалась нашими специалистами -- [**обратитесь в чат поддержки**](./../about/support.md), мы подскажем нужные данные для ввода.
