...
> [!NOTE]
> 
> Клиентские пк каждого клуба должны быть подключены к сети именно того сервера, на котором заведены филиалы -- в остальном настройка станций не отличается от настройки одного клуба, описанной в статье [«Установка»](./../../instalation/_index.md).
