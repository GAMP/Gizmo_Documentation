...
![](./add-app-to-shell.webp){width=608px height=337px}
...
![](./add-app-to-shell-2.webp){width=805px height=173px}
...
>
> ![](./add-app-to-shell-5.webp){width=807px height=389px}
...
![](./add-app-to-shell-6.webp){width=807px height=349px}
