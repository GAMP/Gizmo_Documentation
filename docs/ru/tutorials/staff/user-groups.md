...
> [!NOTE]
> 
> Здесь описан общий принцип работы с группами. Точный список всех настраиваемых правил группы (лимиты, приоритеты, комбинация с индивидуальными скидками) появится в этой статье отдельно, после сверки с актуальным интерфейсом.
