...
В разделе «Журналы» собраны логи о работе системы Gizmo:

-  Сообщения от Gizmo Client;

-  Сообщения от Gizmo Server;

-  Операции, критические ошибки и изменения в работе сервиса или оболочки;

-  Оповещения об исполнении задачи с таймером, сценарием выполнения, отработка скриптов и другое.

Раздел доступен в левом меню <cmd text="Журналы"/>.
