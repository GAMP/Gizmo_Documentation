...
<body>
  <section class="gx-hero">
    ...
    <h1 class="gx-title">
      Как настроить пользовательское соглашение для клуба и стилизовать его в <span class="gx-accent">Gizmo</span>
    </h1>
